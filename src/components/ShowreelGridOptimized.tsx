...
// Оптимизированная карточка проекта
        ...
        <div className="glass-card overflow-hidden group card-hover shadow-sm">
            ...
            <div className="p-6">
                <div className="flex items-center justify-between mb-3">
                    <span className="px-2 py-1 rounded-full bg-red-600/20 dark:bg-red-500/20 text-red-600 dark:text-red-500 text-xs font-medium">
                        {project.category}
                    </span>
                ...
                <h3
                    className="text-2xl md:text-3xl font-frantz font-black text-slate-900 dark:text-white mb-2 uppercase tracking-wide leading-none group-hover:text-red-600 dark:group-hover:text-red-500 transition-colors"
                ...
                <p className="text-slate-600 dark:text-dark-300 mb-4 text-sm">
                    {project.description}
                </p>
                ...
                <div className="flex flex-wrap gap-1.5 mb-4">
                    ...
                    {project.tags.length > 3 && (
                        <span className="px-2 py-1 rounded bg-slate-200 dark:bg-dark-800 text-slate-600 dark:text-dark-300 text-xs">
                            +{project.tags.length - 3}
                        </span>
                    )}
                </div>
                ...
                {/* Results */}
                <div className="flex flex-wrap gap-3 pt-4 border-t border-slate-200 dark:border-dark-700">
                    ...
                    {project.results.length > 2 && (
                        <span className="text-sm text-slate-500 dark:text-dark-400">
                ...
                {project.slug && (
                    <Link
                        ...
                        className="inline-flex items-center gap-2 mt-4 text-red-600 dark:text-red-500 hover:text-red-700 dark:hover:text-red-400 font-medium transition-colors group text-sm"
                    >
