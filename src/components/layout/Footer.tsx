                    ...
                    <div className="flex gap-3">
                        {footerLinks.social.map((link) => (
                            <a
                                ...
                                className="w-10 h-10 rounded-full bg-slate-100 dark:bg-dark-800 flex items-center justify-center text-orange-600 dark:text-primary-400 hover:text-white hover:bg-gradient-to-r hover:from-orange-500 hover:to-green-500 dark:hover:from-primary-500 dark:hover:to-accent-500 transition-all duration-300 shadow-sm"
                        ...
                        <ul className="space-y-2.5 text-sm">
                            {footerLinks.services.map((link) => (
                                <li key={link.href}>
                                    <Link
                                        href={link.href}
                                        className="text-slate-600 dark:text-dark-400 hover:text-orange-500 dark:hover:text-primary-500 transition-colors duration-300"
                                    >
                                        {link.label}
                                    </Link>
                                </li>
                ...
                <div className="md:hidden mb-8 p-4 rounded-2xl bg-cream-100 dark:bg-dark-900/50 border border-slate-100 dark:border-dark-800">
                    ...
                    <div className="flex flex-col gap-3">
                        <a
                            ...
                            className="flex items-center justify-center gap-2 py-2.5 px-4 rounded-xl bg-cream-50 dark:bg-dark-800 text-slate-600 dark:text-dark-400 hover:text-orange-500 dark:hover:text-primary-500 transition-all duration-300 text-sm shadow-sm"
                        >
                            <svg className="w-4 h-4 text-orange-500 dark:text-primary-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="flex items-center justify-center gap-2 py-2.5 px-4 rounded-xl bg-cream-50 dark:bg-dark-800 text-slate-600 dark:text-dark-400 hover:text-green-500 transition-all duration-300 text-sm shadow-sm"
                            >
                            ...
                            <div className="flex items-center justify-center gap-2 py-2.5 px-4 rounded-xl bg-cream-50 dark:bg-dark-800 text-slate-600 dark:text-dark-400 text-sm shadow-sm">
                                <svg className="w-4 h-4 text-orange-500 dark:text-primary-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <div className="flex gap-3">
                            {footerLinks.social.map((link) => (
                                <a
                                    ...
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="w-9 h-9 rounded-full bg-slate-100 dark:bg-dark-800 flex items-center justify-center text-orange-600 dark:text-primary-400 hover:text-white hover:bg-gradient-to-r hover:from-orange-500 hover:to-green-500 dark:hover:from-primary-500 dark:hover:to-accent-500 transition-all duration-300"
                                    aria-label={link.label}
                                >
                                    <SocialIcon name={link.icon} />
                                </a>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-slate-600 dark:text-dark-400 text-sm">
                            <li className="flex items-center gap-2">
                                ...
                                <a href="mailto:alekseevpo@gmail.com" className="hover:text-orange-500 dark:hover:text-primary-500 transition-colors truncate">
                                    alekseevpo@gmail.com
                                </a>
                            </li>
                            <li className="flex items-center gap-2">
                                ...
                                <a href="https://wa.me/34624682795" target="_blank" rel="noopener noreferrer" className="hover:text-orange-500 dark:hover:text-primary-500 transition-colors">
                                    WhatsApp
                                </a>
                            </li>
                            <li className="flex items-center gap-2">
