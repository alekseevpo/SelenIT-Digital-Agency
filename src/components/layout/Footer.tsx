...
const getFooterLinks = (lang: string) => ({
    services: [
        { href: `/${lang}/services#web-development`, label: 'Web Development' },
        { href: `/${lang}/services#ui-ux-design`, label: 'UI/UX Design' },
        { href: `/${lang}/services#ecommerce`, label: 'E-Commerce' },
        { href: `/${lang}/services#maintenance`, label: 'Support & Maintenance' },
    ],
    company: [
        { href: `/${lang}/about`, label: 'About Us' },
        { href: `/${lang}/showreel`, label: 'Showreel' },
        { href: `/${lang}/contact`, label: 'Contact' },
        { href: `/${lang}/careers`, label: 'Careers' },
    ],
    social: [
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-dark-400">
                            <li className="flex items-center gap-3">
                                ...
                                <a href="mailto:hello@selen.it" className="hover:text-primary-400 transition-colors">
                                    hello@selen.it
                                </a>
                            </li>
                            <li className="flex items-center gap-3">
