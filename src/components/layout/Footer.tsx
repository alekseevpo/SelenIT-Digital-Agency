...
const getFooterLinks = (lang: string, dict: Dictionary) => {
    return {
        ...
        company: [
            ...
            {
                href: `/${lang}/careers`,
                label: lang === 'ru' ? 'Вакансии' : lang === 'es' ? 'Vacantes' : 'Careers',
            },
        ],
        social: [
            ...
            <div className="container-custom py-10 md:py-12 px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-2 gap-6 md:hidden mb-8">
                    ...
                    <div className="text-center">
                        ...
                        <ul className="space-y-2.5 text-sm text-center mx-auto max-w-fit">
                            {footerLinks.services.map((link) => (
                                <li key={link.href}>
                                    <Link
                                        href={link.href}
                                        className="text-slate-600 dark:text-dark-400 hover:text-red-600 dark:hover:text-red-500 transition-colors duration-300"
                                    >
                                        {link.label}
                                    </Link>
                                </li>
