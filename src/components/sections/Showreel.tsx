          ...
          <div className="max-w-4xl mx-auto text-center">
            <Reveal width="100%" delay={0.3}>
              <h2
                ...
                style={{ display: 'inline-block', transform: 'scaleY(1.7) scaleX(1.05)', transformOrigin: 'center' }}
              >
            ...
            <Reveal key={project.id} delay={0.1 * index}>
              <div className="glass-card group relative overflow-hidden shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 aspect-[16/10] flex flex-col justify-end p-6 md:p-8">
                <div className="relative z-10">
                  ...
                  <Link href={`/${lang}/showreel`} className="inline-flex items-center text-sm text-slate-700 dark:text-slate-300 font-medium hover:text-orange-500 dark:hover:text-primary-400 transition-colors group/link">
