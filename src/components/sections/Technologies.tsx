...
const TechIcon = ({ name, color }: { name: string; color: string }) => {
    const icons: Record<string, JSX.Element> = {
        'React': (
            <svg viewBox="0 0 24 24" className="w-9 h-9 md:w-10 md:h-10" fill={color}>
        ...
        'Next.js': (
            <svg viewBox="0 0 24 24" className="w-9 h-9 md:w-10 md:h-10 dark:fill-white fill-slate-900">
    ...
    return icons[name] || <div className="w-9 h-9 md:w-10 md:h-10 rounded-lg bg-gradient-to-br from-primary-500 to-accent-500" />;
};
