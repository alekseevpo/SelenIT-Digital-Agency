                    ...
                    <div className="max-w-4xl mx-auto">
                        <div className="prose prose-lg prose-slate dark:prose-invert max-w-none">
                            <p className="mb-4 text-body leading-relaxed">
                                В мире, где средний пользователь видит до 10 000 рекламных сообщений
                                в день, «просто логотипа» уже недостаточно. Чтобы клиент выбрал вас,
                                а не конкурента с ценой на 5% ниже, ваш бренд должен обладать чем-то
                                большим, чем симпатичная картинка. Он должен обладать{' '}
                                <strong>характером, ценностями и ДНК</strong>.
                            </p>
                            <p className="mb-4 text-body leading-relaxed">
                                В{' '}
                                ...
                                мы не просто «рисуем бренды» — мы проектируем эмоциональный опыт,
                                который заставляет аудиторию влюбляться.
                            </p>
                            ...
                            <p className="mb-4 text-body leading-relaxed">
                                Запоминающийся бренд начинается не с выбора шрифта, а с ответов на
                                неудобные вопросы:{' '}
                                <em>
                                    «Почему вы существуете? Какую проблему вы решаете так, как никто
                                    другой?»
                                </em>
                            </p>
                            <ul className="list-disc list-inside mb-4 text-body space-y-2">
                                <li>
                                    <strong>Исследование:</strong> Мы анализируем рынок и
                                    конкурентов, чтобы найти «белое пятно» — ту нишу, где вы будете
                                    звучать громче всех.
                                </li>
                                <li>
                                    <strong>Позиционирование:</strong> Мы формулируем суть бренда.
                                    Это тот самый «крючок», который зацепит вашу целевую аудиторию.
                                </li>
                            </ul>

                            <h3 className="heading-2 mb-3 text-slate-900 dark:text-white">
                                2. Визуальная айдентика: Лицо, которое{' '}
                                <span className="text-red-600 dark:text-red-500">
                                    узнают из тысячи
                                </span>
                            </h3>
                            <p className="mb-4 text-body leading-relaxed">
                                Визуальный стиль — это не мода, это коммуникация. Цвет, типографика
                                и графические элементы должны работать на подсознание.
                            </p>
                            <ul className="list-disc list-inside mb-4 text-body space-y-2">
                                <li>
                                    Мы создаем дизайн, который передает ваше сообщение за доли
                                    секунды.
                                </li>
                                <li>
                                    <strong>Системность:</strong> Ваш бренд будет выглядеть
                                    одинаково дорого и профессионально как на иконке мобильного
                                    приложения, так и на огромном билборде.
                                </li>
                            </ul>
                            ...
                            <p className="mb-4 text-body leading-relaxed">
                                Бренды, которые запоминаются, умеют разговаривать. Они могут быть
                                дерзкими, заботливыми, экспертными или ироничными. Мы помогаем найти
                                тот уникальный тон, который сделает общение с вашими клиентами
                                личным и доверительным.
                            </p>

                            <h3 className="heading-2 mb-3 text-slate-900 dark:text-white">
                                4. Развитие: Бренд как{' '}
                                <span className="text-red-600 dark:text-red-500">
                                    живой организм
                                </span>
                            </h3>
                            <p className="mb-4 text-body leading-relaxed">
                                Создать бренд — это только 20% успеха. Остальные 80% — это его
                                внедрение и поддержка.
                            </p>
                            <ul className="list-disc list-inside mb-4 text-body space-y-2">
                                <li>
                                    Мы помогаем интегрировать бренд во все точки контакта с
                                    клиентом.
                                </li>
                                <li>
                                    Разрабатываем стратегию продвижения, чтобы о вас не просто
                                    узнали, а начали говорить.
                                </li>
                            </ul>

                            <blockquote className="border-l-4 border-red-600 pl-6 my-6 text-slate-700 dark:text-slate-300">
                                <p>
                                    Брендинг — это долгосрочная инвестиция в добавочную стоимость.
                                    Сильный бренд позволяет продавать дороже, нанимать лучших
                                    сотрудников и сохранять лояльность клиентов годами.
                                </p>
                            </blockquote>

                            <h3 className="heading-2 mb-3 text-slate-900 dark:text-white">
                                Почему стоит доверить{' '}
                                <span className="text-red-600 dark:text-red-500">это</span> SELEN.
                                <span className="text-red-600 dark:text-red-500">IT?</span>
                            </h3>
                            <p className="mb-4 text-body leading-relaxed">
                                Мы объединяем аналитический подход digital-агентства с креативным
                                видением. Мы не предлагаем шаблонных решений, потому что ваш бизнес
                                уникален. Наша задача — сделать так, чтобы при упоминании вашей ниши
                                у клиента в голове сразу всплывало название вашей компании.
                            </p>
                            ...
                            <div className="bg-cream-50 dark:bg-dark-800 rounded-2xl p-8 my-6 border border-slate-200 dark:border-dark-700">
                                <p className="text-center text-lg font-semibold text-slate-900 dark:text-white mb-4">
                                    Готовы заявить о себе так, чтобы вас невозможно было
                                    игнорировать?
                                </p>
                                <p className="text-center text-body mb-6">
                                    Хотите, я подготовлю для вас краткий бриф или план бесплатной
                                    консультации, чтобы мы могли обсудить ваш будущий бренд?
                                </p>
                            </div>
                        </div>
                    </div>
