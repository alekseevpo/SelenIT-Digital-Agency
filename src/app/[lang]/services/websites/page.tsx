...
const content = {
    en: {
        ...
        bullets: ['Next.js performance', 'UI/UX & animations', 'CMS integration', 'SEO-ready structure'],
    },
    ru: {
        badge: 'Сайты',
        ...
        subtitle: 'Быстрые, доступные и продуманные сайты, которые работают на результат и легко масштабируются.',
        bullets: ['Производительность Next.js', 'UI/UX и анимации', 'Интеграция CMS', 'SEO-ready структура'],
    },
    es: {
        badge: 'Websites',
        title1: 'Websites que',
        ...
        bullets: ['Rendimiento con Next.js', 'UI/UX y animaciones', 'Integración de CMS', 'Estructura lista para SEO'],
    },
} as const;
