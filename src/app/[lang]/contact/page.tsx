                            ...
                            <div className="space-y-4">
                                {contactInfo.map((item) => (
                                    <a
                                        ...
                                        className="flex items-center gap-4 p-4 rounded-xl bg-cream-100 dark:bg-black border border-slate-200 dark:border-dark-700 transition-all group w-full"
                                    >
                                        <div className="w-12 h-12 rounded-lg flex items-center justify-center text-red-600 dark:text-red-500 transition-colors">
                                            {item.icon}
                                        </div>
                                        <div>
